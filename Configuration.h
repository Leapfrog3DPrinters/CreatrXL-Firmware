...
#define STRING_VERSION_CONFIG_H "Creatr XL SW V1.00" //Personal revision number for changes to THIS file.
...
#define EXTR2_X_OFFSET 33.0
#define EXTR2_Y_OFFSET -0.15
